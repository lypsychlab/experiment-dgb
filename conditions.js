var conditions = [
    {
        ...
        "outcome_tempt": "Emma could go talk with her friends right now instead of cleaning her apartment, and she <u>wants</u> to do that.",
        "outcome_notempt": "Abby could go talk with her friends right now instead of cleaning her apartment, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Adam could play video games instead of reading, and he <u>wants</u> to do that.",
        "outcome_notempt": "Mike could play video games instead of reading, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Grace could text the friend instead of paying attention to the meeting, and she <u>wants</u> to do that.",
        "outcome_notempt": "Amelia could text the friend instead of paying attention to the meeting, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Mason could watch football instead of working on his application, and he <u>wants</u> to do that.",
        "outcome_notempt": "Ian could watch football instead of working on his application, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Rose could order takeout instead of cooking, and she <u>wants</u> to do that.",
        "outcome_notempt": "Lia could order takeout instead of cooking, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "William could smoke the cigarette, and he <u>wants</u> to do that.",
        "outcome_notempt": "Harry could smoke the cigarette, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Piper could eat the cake, and she <u>wants</u> to do that.",
        "outcome_notempt": "Lucy could eat the cake, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "James could stay up late texting them, and he <u>wants</u> to do that.",
        "outcome_notempt": "Richard could stay up late texting them, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Thalia could knock out her opponent, and she <u>wants</u> to do that.",
        "outcome_notempt": "Reagan could knock out her opponent, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Mary could smoke now, and she <u>wants</u> to do that.",
        "outcome_notempt": "Alice could smoke now, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Sara could take the money from the wallet, and she <u>wants</u> to do that.",
        "outcome_notempt": "Ariana could take the money from the wallet, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Samantha could lie to avoid the commitment, and she <u>wants</u> to do that.",
        "outcome_notempt": "Audrey could lie to avoid the commitment, but she <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Kevin could steal the scissors, and he <u>wants</u> to do that.",
        "outcome_notempt": "Ben could steal the scissors, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Oliver could stay silent about the pest problem, and he <u>wants</u> to do that.",
        "outcome_notempt": "Keith could stay silent about the pest problem, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Matthew could leave the coworker to finish their work alone, and he <u>wants</u> to do that.",
        "outcome_notempt": "Edward could leave the coworker to finish their work alone, but he <u>doesn't want</u> to do that.",
    ...
    },
    {
        ...
        "outcome_tempt": "Dylan could accept the invitation, and he <u>wants</u> to do that.",
        "outcome_notempt": "Jake could accept the invitation, but he <u>doesn't want</u> to do that.",
